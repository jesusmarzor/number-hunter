...
export const Home = () => {
    ...
    return (
        <div className="w-full min-h-screen flex justify-center items-center font-[EduSABeginner]">
            <div className="w-96 h-96 rounded flex flex-col justify-start items-center bg-[#F3F3F3] overflow-hidden">
                ...
                <div className="relative w-[50%] h-[50%] rounded-full bg-[#61C0BF] text-[#F3F3F3]">
                    ...
                    <div className="absolute bottom-1 left-1 bg-[#F3F3F3] w-12 h-12 flex justify-center items-center rounded-full bg- border-4 border-[#FFB6FF]">
